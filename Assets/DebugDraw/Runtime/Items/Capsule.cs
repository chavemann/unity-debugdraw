...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Capsule : BaseLineItem
	{
		...
		public static Capsule Get(ref Vector3 p1, ref Vector3 p2, float radius, ref Color color, int segments = 32, EndTime? duration = null)
		{
		...
		/// <returns>The Capsule object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Capsule GetWire(ref Vector3 p1, ref Vector3 p2, float radius, ref Color color, int segments = 32, EndTime? duration = null)
		{
			Capsule item = ItemPool<Capsule>.Get(duration);
