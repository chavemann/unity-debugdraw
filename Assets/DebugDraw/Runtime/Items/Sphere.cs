...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Sphere : BasePointItem
	{
		...
		public static Sphere Get(ref Vector3 position, float radius, ref Color color, int segments = 32, EndTime duration = default)
		{
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere Get(ref Vector3 position, ref Vector3 radius, ref Color color, int segments = 32, EndTime duration = default)
		{
			Sphere item = ItemPool<Sphere>.Get(duration);
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere Get(ref Vector3 position, ref Vector3 radius, ref Quaternion orientation, ref Color color, int segments = 32, EndTime duration = default)
		{
			Sphere item = ItemPool<Sphere>.Get(duration);
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere GetWire(ref Vector3 position, float radius, ref Color color, int segments = 32, EndTime duration = default)
		{
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere GetWire(ref Vector3 position, ref Vector3 radius, ref Color color, int segments = 32, EndTime duration = default)
		{
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere GetWire(ref Vector3 position, ref Vector3 radius, ref Quaternion orientation, ref Color color, int segments = 32, EndTime duration = default)
		{
