...
public class Sphere : BasePointItem
	{
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere GetWire(ref Vector3 position, ref Vector3 radius, ref Color color, int segments = 32, EndTime? duration = null)
		{
		...
		/// <returns>The Sphere object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Sphere GetWire(ref Vector3 position, ref Vector3 radius, ref Quaternion orientation, ref Color color, int segments = 32, EndTime? duration = null)
		{
