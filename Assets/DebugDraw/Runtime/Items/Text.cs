...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Text : BasePointItem
	{
		...
		public static Text Get(ref Vector3 position, string text, ref Color color, TextAnchor align = TextAnchor.UpperLeft, float scale = 1, EndTime duration = default)
		{
		...
		/// <returns>The Text object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Text Get(ref Vector3 position, string text, TextAnchor align = TextAnchor.UpperLeft, float scale = 1, EndTime duration = default)
		{
