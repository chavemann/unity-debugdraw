...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Lines3D : BaseItem
	{
		...
		public static Lines3D Get(List<Vector3> positions, List<float> sizes, List<Color> colors, EndTime duration = default)
		{
		...
		/// <returns>The Line object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Lines3D Get(List<Vector3> positions, List<float> sizes, List<Color> colors, Vector3? facing, EndTime duration = default)
		{
			Lines3D item = ItemPool<Lines3D>.Get(duration);
