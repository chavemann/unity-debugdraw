...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Cone : BasePointItem, IAttachableLine
	{
		...
		public static Cone Get(ref Vector3 origin, ref Vector3 direction, float length, float angle, ref Color color, int segments = 32, bool round = false, bool drawCap = false, EndTime duration = default)
		{
		...
		/// <returns>The Cylinder object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Cone GetWire(ref Vector3 origin, ref Vector3 direction, float length, float angle, ref Color color, int segments = 32, bool round = false, bool drawCap = false, EndTime duration = default)
		{
