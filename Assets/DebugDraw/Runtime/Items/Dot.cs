...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Dot : BasePointItem
	{
		...
		public static Dot Get(ref Vector3 position, float radius, ref Color color, int segments = 0, EndTime duration = default)
		{
		...
		/// <returns>The Dot object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Dot Get(ref Vector3 position, float radius, ref Color color, ref Vector3 facing, int segments = 0, EndTime duration = default)
		{
			Dot item = ItemPool<Dot>.Get(duration);
