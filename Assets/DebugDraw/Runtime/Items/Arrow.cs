...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Arrow : Line
	{
		...
		public static Arrow Get(
			...
			bool faceCamera = false, bool autoSize = false, float? duration = null)
		{
		...
		public static Arrow Get(
			ref Vector3 p1, ref Vector3 p2, ref Color color1, ref Color color2,
			float startSize, float endSize, bool faceCamera = false, bool autoSize = false, float? duration = null)
		{
			return Get(
		...
		/// <returns>The Arrow object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Arrow Get(ref Vector3 p1, ref Vector3 p2, ref Color color1, ref Color color2, float size, bool faceCamera = false,bool autoSize = false, float? duration = null)
		{
			return Get(
		...
		/// <returns>The Arrow object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Arrow Get(ref Vector3 p1, ref Vector3 p2, ref Color color, float size, bool faceCamera = false,bool autoSize = false, float? duration = null)
		{
			return Get(
