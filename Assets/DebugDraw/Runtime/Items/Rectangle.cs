...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Rectangle : BasePointItem
	{
		...
		public static Rectangle GetFill(ref Vector3 position, float size, ref Vector3 facing, ref Color color, EndTime duration = default)
		{
		...
		/// <returns>The ellipse object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Rectangle Get(ref Vector3 position, float size, ref Vector3 facing, ref Color color, EndTime duration = default)
		{
			Rectangle item = ItemPool<Rectangle>.Get(duration);
		...
		/// <returns>The ellipse object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Rectangle GetFill(ref Vector3 position, ref Vector2 size, ref Vector3 facing, ref Color color, EndTime duration = default)
		{
			Rectangle item = ItemPool<Rectangle>.Get(duration);
		...
		/// <returns>The ellipse object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Rectangle Get(ref Vector3 position, ref Vector2 size, ref Vector3 facing, ref Color color, EndTime duration = default)
		{
			Rectangle item = ItemPool<Rectangle>.Get(duration);
