...
namespace DebugDrawUtils.DebugDrawItems
{
	...
	public class Line : BaseLineItem, IAttachablePoint
	{
		...
		public static Line Get(ref Vector3 p1, ref Vector3 p2, ref Color color1, ref Color color2, float? duration = null)
		{
		...
		/// <returns>The Line object.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Line Get(ref Vector3 p1, ref Vector3 p2, ref Color color, float? duration = null)
		{
